      ...
      <form method="post" action="cart.php" id="cart">
        ...
        <tr>
          ...
          <td class="center-checkbox"><input type="checkbox" name="items[]"
            value="duc" id="duc" <?php if(isset($_SESSION["duc"])) echo 'checked="checked"'?>>
        ...
        <tr>
          ...
          <td class="center-checkbox"><input type="checkbox" name="items[]"
            value="gxr" id="gxr" <?php if(isset($_SESSION["gxr"])) echo 'checked="checked"'?>>
        ...
        <tr>
          ...
          <td class="center-checkbox"><input type="checkbox" name="items[]"
            value="cbr" id="cbr" <?php if(isset($_SESSION["cbr"])) echo 'checked="checked"'?>>
        ...
        <tr>
          ...
          <td class="center-checkbox"><input type="checkbox" name="items[]"
            value="bmw" id="bmw" <?php if(isset($_SESSION["bmw"])) echo 'checked="checked"'?>>
